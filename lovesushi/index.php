...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <!-- Default box -->
      <div class="card" style="margin-top: -32px; background-image: url(../dist/img/sushi.jpeg);">
    ...
    <!-----------MODAL VER MAIS ----------->
      ...
      <div id="myWorkContent">
        ...
        ?>
          <a href=""><img src="../dist/categorias/<?=$linhas["logo"]?>" height="50%" style="border-radius:8px; margin-right:3px"></a>
        <?php
          }
        ?>
